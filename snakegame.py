...
class SNAKE:
    def __init__(self):
        ...
        self.body_tr = pygame.image.load('snake_graphics/body_tr.png').convert_alpha()
        self.body_tl = pygame.image.load('snake_graphics/body_tl.png').convert_alpha()
        self.body_br = pygame.image.load('snake_graphics/body_br.png').convert_alpha()
        self.body_bl = pygame.image.load('snake_graphics/body_bl.png').convert_alpha()
